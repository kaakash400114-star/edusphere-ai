...
### Photosynthesis
- **Definition**: The process by which green plants make food using sunlight, water, carbon dioxide, and chlorophyll.
- **Equation**:
  ```
...
- **Nitrogen fixation**: Rhizobium bacteria convert atmospheric nitrogen into usable nitrates.
- Decomposition by saprophytes returns nutrients to soil.
...
- **Herbivores**: Eat plants only (cow, goat, deer).
- **Carnivores**: Eat flesh only (lion, tiger, eagle).
- **Omnivores**: Eat both plants and flesh (humans, bear, crow).
- **Parasites**: Live on/in host body and derive nutrition (tapeworm, lice, mosquito, Cuscuta).
- **Scavengers**: Feed on dead animals (vulture, hyena).
- **Decomposers**: Break down dead organic matter (bacteria, fungi).

### Modes of Feeding
- **Scraping**: Snail (radula).
- **Siphoning**: Mosquito (proboscis).
- **Capturing & Swallowing**: Snake, frog.
- **Chewing/Cutting**: Grasshopper, lion (teeth adapted to diet).
- **Sucking**: Butterfly (proboscis), leech.
- **Licking**: Dog, bear.
...
### Types of Teeth (Human)
| Type | Function | Count |
|------|----------|-------|
| Incisors | Cutting/biting | 8 (4 each jaw) |
| Canines | Tearing | 4 (2 each jaw) |
| Premolars | Crushing/grinding | 8 (4 each jaw) |
| Molars | Grinding | 12 (6 each jaw) |
| **Total** | | **32** |

- **Milk Teeth**: 20 teeth; fall out and are replaced by permanent teeth.
- **Tooth Decay (Dental Caries)**: Caused by bacteria acting on sugar → produce acid → enamel dissolves → cavity forms. Prevent by brushing twice daily.

### Digestion in Amoeba & Paramecium
- **Amoeba**: Pseudopodia engulf food → food vacuole formed → digestive enzymes break down food → absorbed → undigested expelled through cell membrane.
- **Paramecium**: Cilia sweep food into oral groove → cytostome → food vacuole → digestion.
...
### Animal Fibres
- **Wool** and **Silk** are animal fibres (protein fibres). Plant fibres include cotton, jute.
...
- **Life Cycle of Silkworm** (4 stages — complete metamorphosis):
  ...
  4. **Adult (Silk Moth)**: Emerges from cocoon after metamorphosis; female lays eggs → cycle repeats.
- **Sericulture**: Rearing of silkworms for silk production.
- **Processing**: Rearing → Sorting cocoons → **Boiling** (kills pupa, softens silk; also prevents moth from breaking cocoon) → Reeling (unwinding silk thread from cocoon) → Spinning → Weaving.
- A single cocoon can yield a continuous silk thread of about **900 metres**.
...
### Heat & Temperature
- **Heat**: Form of energy; flows from hot to cold body. Measured in **Joules (J)**.
- **Temperature**: Degree of hotness/coldness. Measured in **°C (Celsius)**, **°F (Fahrenheit)**, or **K (Kelvin)**.
...
- **Insulators (Poor Conductors)**: Do not allow heat easily (wood, plastic, rubber, air, water). Woollen clothes keep us warm in winter (wool + trapped air = insulator).

### Sea Breeze & Land Breeze
- **Sea Breeze (Day)**: Land heats faster than sea → air over land rises → cooler air from sea moves in.
...
- **Synthetic/Chemical Indicators**: Methyl orange, Phenolphthalein.
- **Olfactory Indicators**: Change smell in acidic/basic media (e.g., onion, vanilla extract, clove oil).
...
| China Rose | **Red/Magenta** | **Green** |
| Red Cabbage Juice | **Red** | **Green/Yellow** |
...
### Physical Change
- **Definition**: Change in physical properties (shape, size, state, colour) only; **no new substance** is formed.
- **Properties**: Temporary/reversible; same chemical composition; no change in mass.
- **Examples**: Melting of ice, boiling of water, dissolving sugar in water, cutting paper, breaking glass, stretching rubber band, crushing a can, magnetising iron, glowing of electric bulb.
...
### Crystallisation
- **Definition**: Process of forming **crystals** from a hot saturated solution on cooling.
- **Examples**: Salt from seawater, sugar from sugar solution, formation of snowflakes, gems.
- **Separation technique**: Used to obtain pure solid from a solution (e.g., obtaining copper sulphate crystals, salt from salt water, alum crystals).
- **Process**: Dissolve impure solid in minimum hot water → filter to remove insoluble impurities → allow filtrate to cool slowly → crystals form → filter to separate crystals → wash with cold water → dry.
...
### Adaptations (Key Examples)
- **Polar Bear**: White fur (camouflage + insulation), thick layer of fat (blubber) under skin, small ears/short tail (reduce heat loss), padded feet (walking on snow).
- **Penguin**: White belly/black back (counter-shading for camouflage), thick skin & fat, huddling behaviour.
- **Camel (Desert)**: Long legs (body above hot sand), thick sole pads, drinks water once, stores fat in hump (not water!), very little urine/sweat, can tolerate high body temp changes, long eyelashes & nostril flaps (sand protection).
- **Mountain Goat**: Thick fur, strong hooves for climbing, sure-footed.
- **Deer/Forest Animals**: Strong legs (running), brown coat (camouflage), sharp hearing.
- **Lion (Grassland)**: Brown coat (grass camouflage), strong claws & teeth, light body, long claws, keen eyesight.
- **Frog (Aquatic & Land)**: Can live in both water and land (amphibian), webbed feet (swimming), eyes/nose on top of head, breathe through moist skin.
- **Fish**: Streamlined body, gills for breathing, fins for movement, scales for protection.
...
### Sea Breeze & Land Breeze (Detailed)
- **Sea Breeze**: During day, land heats faster → warm air rises → cool air from sea blows towards land.
- **Land Breeze**: During night, land cools faster → sea is warmer → cool air from land blows towards sea.

### Thunderstorms & Lightning
- Warm, moist air rises rapidly → water vapour condenses → releases heat → more air rises → strong upward currents → large dark cumulonimbus clouds form → heavy rain, strong winds, lightning, thunder.
- **Lightning**: Electric discharge between clouds or between cloud and ground (caused by friction between water droplets → charge separation). Very dangerous.
- **Safety during lightning**: Stay indoors, avoid open spaces, don't stand under tall trees, don't use electrical appliances/wired phones, avoid water, stay inside car (acts as Faraday cage), avoid metal objects.

### Cyclones
- **Definition**: Violent rotating wind storm with very low pressure at centre, heavy rain.
- **How cyclones form**:
  1. Warm water (>27°C) evaporates.
...
### Tornadoes
- Violent rotating funnel of air touching the ground. Form over land. Short-lived but very destructive. Narrow but extremely high wind speeds.

### Disaster Management
- **Cyclone warnings**: Issued by IMD (India Meteorological Department) through radio, TV, newspapers.
- **Safety measures**: Board up windows, store food/water, move to safe shelter, avoid flooded areas, follow evacuation orders, keep emergency kit ready.
- **Technology**: Satellites (INSAT), radar, cyclone warning centres help predict and track cyclones.
...
- **Soil**: Upper layer of Earth's crust that supports plant growth. Formed by **weathering of rocks** over thousands of years.
- **Soil Profile** (Layers from top to bottom):
  1. **O-Horizon (Topsoil / A-Horizon)**: Topmost layer; dark colour (humus-rich); soft, porous; holds water and air; most nutrients; best for plant growth; formed by decomposition of organic matter.
  2. **A-Horizon**: Mineral-rich but less humus; lighter colour.
  3. **B-Horizon (Subsoil)**: Harder, compact; less humus; contains minerals leached from above layers; fewer roots; sand, silt, clay.
  4. **C-Horizon**: Mostly weathered rock fragments; hardly any organic matter.
  5. **Bedrock (R-Horizon)**: Unweathered solid rock; parent rock from which soil forms.
- **Weathering**: Breakdown of rocks by:
  - **Physical/Mechanical**: Temperature changes, frost, wind, water, roots of plants.
  - **Chemical**: Acidic water, oxidation, carbonation.
  - **Biological**: Plant roots, burrowing animals, lichens, microbes.
...
- Living organisms (earthworms, bacteria, fungi, insects).

### Types of Soil
| Type | Composition | Percolation | Water Holding | Crops Grown | Region |
|------|------------|-------------|--------------|-------------|--------|
...
- **Loamy soil**: Best for agriculture; contains humus; good water retention + drainage + aeration.

### Properties of Soil
- **Percolation rate**: Rate at which water passes through soil (higher in sandy, lower in clayey).
- **Moisture**: Water content in soil.
- **Absorption of water**: Capacity to hold water (highest in clayey).
- **Soil colour**: Darker = more humus = more fertile.
...
- **Causes**: Deforestation, overgrazing, heavy rain, strong winds, improper farming (ploughing along slope), construction.
...
- **Prevention (Soil Conservation)**:
  ...
  - Shelter belts (rows of trees that break wind).
  - Crop rotation, cover cropping.
  - Avoid overgrazing, control deforestation.
  - Grassed waterways, check dams, gully plugging.
...
### Respiration
- **Definition**: Chemical process in which glucose is broken down in cells to release energy (ATP).
- **Equation (Aerobic)**:
  ```
...
|----------|-------------------|
| Humans/Amphibians/Reptiles/Birds/Mammals | Lungs |
| Fish/Prawns | Gills |
| Earthworm | Moist skin (cutaneous respiration) |
| Frog | Skin + Lungs |
| Insects (cockroach, grasshopper) | Spiracles + Tracheal tubes |
| Plants | Stomata (leaves) + Lenticels (stems) |
...
|------|-----------|----------|
| **Arteries** | Thick, elastic walls; narrow lumen; no valves | Carry blood **away** from heart; carry **oxygenated blood** (except pulmonary artery) |
| **Veins** | Thin walls; wide lumen; have **valves** (prevent backflow) | Carry blood **towards** heart; carry **deoxygenated blood** (except pulmonary vein) |
| **Capillaries** | Very thin walls (one cell thick); microscopic | Connect arteries to veins; exchange of gases, nutrients, waste between blood and cells |

#### Human Heart
- **Location**: Chest cavity, between lungs, slightly left of centre; about the size of a fist.
- **Structure**: Made of cardiac muscle; pumps blood; **four chambers**:
...
- **Lymph vessels**: Carry lymph; drain excess fluid from tissues back into blood.
- **Lymph nodes**: Small bean-shaped structures; filter lymph; trap bacteria/pathogens; produce WBCs (fight infection).
- **Functions**: Returns tissue fluid to blood, transports fat (from intestine), fights infection.
...
- **Definition**: New plant grows from vegetative parts (root, stem, leaf) without seeds. Only one parent; offspring identical to parent (clones).

#### Methods:
1. **Budding**: Small projection (bud) grows on parent → detaches → becomes new organism. Example: **Yeast**.
2. **Fragmentation**: Parent breaks into pieces → each piece grows into new plant. Example: **Spirogyra** (algae).
3. **Spore Formation**: Reproduce by spores (microscopic, covered by hard coat). Example: **Bread mould (Rhizopus)**, ferns, mosses.
4. **Vegetative Propagation by Stem**: Potato (eyes/tubers), ginger (rhizome), sugarcane, rose (cutting), cactus, money plant.
5. **Vegetative Propagation by Roots**: Sweet potato, carrot, dahlia (tuberous roots).
6. **Vegetative Propagation by Leaves**: Bryophyllum (leaf buds develop into new plants along leaf margins).
7. **Tissue Culture**: Growing new plants from a small piece of tissue (explant) in nutrient medium under sterile conditions (artificial asexual reproduction). Used for rare/endangered plants.
...
- **Pistil / Carpel (Female part / Gynoecium)**:
  - **Stigma**: Sticky top; receives pollen grains.
  - **Style**: Connects stigma to ovary.
  - **Ovary**: Contains ovules (female gametes / eggs). Ovule → becomes seed. Ovary → becomes fruit.
...
- **Zygote → Embryo → Seed (with stored food + seed coat) → New plant**.

#### Seed Dispersal
- Seeds must be dispersed to avoid overcrowding and competition.
- **Methods**:
...
### Motion
- **Definition**: Change in position of an object with respect to time.
- **Types**:
  - **Rectilinear (Translatory)**: Object moves in a straight line (car on straight road, falling stone).
  - **Circular**: Object moves in a circular path (fan blade, hands of clock, Earth around Sun).
  - **Rotational**: Object spins about an axis (potter's wheel, spinning top, Earth on its axis).
  - **Periodic (Oscillatory/Vibratory)**: Repeats motion after regular intervals (pendulum, swing, heartbeat).
  - **Random**: Irregular, no fixed pattern (movement of bees, Brownian motion of dust).

### Speed
- **Definition**: Distance travelled per unit time.
- **Formula**: Speed = Distance ÷ Time
- **Unit**: m/s (SI), km/h (common).
- **Types**: Uniform speed (constant speed throughout), Non-uniform speed (speed changes).

### Measuring Devices
- **Odometer**: Measures total distance travelled by a vehicle.
- **Speedometer**: Measures instantaneous speed of a vehicle.
...
### Simple Pendulum
- **Bob**: Weight at the end of string.
- **Oscillation**: One complete to-and-fro motion of the pendulum.
- **Time Period (T)**: Time taken for one oscillation. Depends on length of pendulum (longer pendulum = longer time period). Independent of mass of bob and amplitude of swing (for small oscillations).
- **Frequency (f)**: Number of oscillations per second. f = 1/T.

### Distance-Time Graph
- **X-axis**: Time; **Y-axis**: Distance.
- **Straight line with positive slope**: Uniform motion (constant speed).
...
### Electric Current
- **Definition**: Flow of electric charges (electrons) through a conductor.
- **SI Unit**: **Ampere (A)**. Measured by **ammeter** (connected in series).
...
- **Key/Plug Key**: Switch used to connect or disconnect.
...
3. **Chemical Effect**: When current passes through a conducting solution (electrolyte), chemical reactions occur.
   ...
   - **Other effects**: Bubbles of gas produced on electrodes, change in colour of solution, deposit of metal on electrode.

### Safety with Electricity
- Never touch electrical appliances with wet hands.
- Use proper insulation on wires.
- Don't overload electrical circuits (too many appliances on one socket).
- Fuse/MCB protects against overloading and short circuits.
- Rubber/plastic insulating gloves and tools for electrical work.
...
- **Types**:
  - **Regular (Specular) Reflection**: Smooth, polished surface (mirror). Reflected rays are parallel → clear image.
  - **Diffuse (Irregular) Reflection**: Rough surface (paper, wall, table). Reflected rays scatter → no clear image but we can still see objects.
...
- **Convex**: Reflecting surface curved outward (dome-like). Always forms virtual, erect, diminished image. Used as rear-view mirror in vehicles (wider field of view).

### Lenses
- **Definition**: Transparent material with curved surfaces that refract (bend) light.
- **Types**:
  - **Convex Lens**: Thicker at centre, thinner at edges (converging lens). Converges light rays to a point (focus). Can form real/inverted or virtual/erect images. Used in magnifying glass, microscope, telescope, camera, spectacles (for hypermetropia/farsightedness).
...
### Forms of Water
- **Solid (Ice)**: Below 0°C; frozen water; ice caps, glaciers, snow, hail.
- **Liquid (Water)**: Between 0°C and 100°C; rivers, lakes, oceans, groundwater, rain.
- **Gas (Water Vapour)**: Above 100°C (boiling) or through evaporation; invisible; humidity in air.

### Sources of Water
- **Surface water**: Rivers, lakes, ponds, streams.
- **Groundwater**: Water stored underground (aquifers); accessed through wells, hand pumps, tube wells. Recharged by rainwater seeping through soil.
- **Rainwater**: Primary source of freshwater.

### Water Management
- **Depletion of Water Table** (falling groundwater level):
  - **Causes**: Increasing population → more demand; deforestation → less seepage; overuse/overdrawal; paved surfaces → no seepage; industrial/agricultural overuse.
  - **Effects**: Scarcity, droughts, wells drying up, higher pumping costs, land subsidence.
- **Conservation**:
  - **Rainwater Harvesting**: Collecting and storing rainwater for reuse. Roof-top collection → pipes → storage tanks/recharge pits. Reduces runoff, recharges groundwater, reduces flooding.
  - **Drip Irrigation**: Water directly to roots → saves water (used in agriculture).
  - **Avoid Wastage**: Fix leaking taps, reuse water, don't leave taps running.
  - **Afforestation**: Trees help water seep into soil.
  - **Awareness campaigns**.
  - **Bawris / Stepwells** (traditional rainwater harvesting in Rajasthan/Gujarat).
  - **Tanks / Kund** systems in arid regions.

### Importance of Water
- Essential for all life processes (drinking, cooking, bathing, agriculture, industry).
- Medium for biochemical reactions.
- Habitat for aquatic organisms.
- Regulates climate.
- Used for hydroelectric power, transport, recreation.

### Effects of Water Scarcity
- Health problems (dehydration, waterborne diseases).
...
2. **Understorey**: Below canopy; shorter trees & shrubs; receives less light.
3. **Forest Floor**: Lowest layer; dark, humid; covered with dead leaves, decomposing matter; rich in humus. Ferns, mosses, fungi grow here.

### Forest Ecosystem
- **Producers**: Green plants/trees (make food through photosynthesis).
...
- **Food Web**: Interconnected network of food chains; shows complex feeding relationships.
...
8. **Source of Products**:
   - **Wood**: Timber, furniture, paper, fuel, plywood.
   - **Non-wood**: Fruits, flowers, honey, gum, resin, lac, wax, rubber, medicines, turpentine.
   - **Minor forest produce**: Seeds, nuts, herbs, mushrooms.
9. **Livelihood**: Many tribal people depend on forests for food, shelter, medicine, employment.
10. **Beauty & Recreation**: Tourism, trekking, research.
11. **Windbreaks**: Protect nearby areas from strong winds.

### Deforestation
- **Definition**: Clearing of forests for other land uses (agriculture, urbanisation, industry, mining, dams, roads).
- **Causes**: Growing population, demand for wood/timber, agriculture expansion, industrialisation, mining, grazing, road construction.
- **Effects**:
...
- Many tribal communities (e.g., Adivasis) live in and near forests.
- Depend on forests for food, medicine, shelter, fuel, income.
- Have traditional knowledge of forest plants and ecology.
- Forest conservation must respect their rights and livelihoods.
...
| Humus | Dark, decomposed organic matter in topsoil |
| Erosion | Removal of topsoil by wind/water |
| Respiration | Breakdown of glucose in cells to release energy |
...
| Ammeter | Device measuring electric current |
| Electroplating | Coating one metal on another using electric current |
...
| Deforestation | Clearing of forest land |
| Canopy | Topmost layer of forest formed by tall tree crowns |
| Xylem | Plant tissue transporting water & minerals (upward) |
| Phloem | Plant tissue transporting food (bidirectional) |

---

*End of CBSE Class 7 Science Notes*
