...
### The Five Kingdoms
Scientists classify all living things into five major kingdoms based on their characteristics:

| Kingdom | Cell Type | Examples | Key Features |
|---|---|---|---|
| **Monera** (Bacteria) | Prokaryotic (no nucleus) | Bacteria, cyanobacteria | Single-celled, microscopic |
| **Protista** | Eukaryotic (has nucleus) | Amoeba, paramecium, algae | Mostly single-celled, some multicellular |
| **Fungi** | Eukaryotic | Mushrooms, yeast, mold | Decomposers, absorb nutrients |
| **Plantae** | Eukaryotic | Trees, ferns, flowers | Multicellular, make their own food (photosynthesis) |
| **Animalia** | Eukaryotic | Mammals, insects, fish | Multicellular, consume other organisms |
...
### Where It Happens
Photosynthesis occurs in the **chloroplasts** of plant cells, specifically in the **thylakoid membranes** and the **stroma** (fluid inside the chloroplast). Chlorophyll, the green pigment in chloroplasts, absorbs light energy.
...
- Produces **oxygen** that all animals breathe
- Forms the base of almost all **food chains** (plants are primary producers)
- Removes **carbon dioxide** from the atmosphere
- Stores solar energy in a usable chemical form

---

## 3. Cellular Respiration

Cellular respiration is the process cells use to break down glucose and release energy in the form of ATP.
...
Notice: this is essentially the **opposite** of photosynthesis!

### Where It Happens
- In plants: occurs in **mitochondria** (not chloroplasts)
- In animals: occurs in **mitochondria** of every cell

### The Two Main Stages

**Stage 1: Glycolysis**
- Occurs in the **cytoplasm** (outside the mitochondria)
- One molecule of glucose is broken into **two molecules of pyruvate**
- Produces a small amount of ATP (2 molecules)

**Stage 2: Aerobic Respiration** (requires oxygen)
- Pyruvate enters the **mitochondria**
- Goes through the **citric acid cycle (Krebs cycle)** and the **electron transport chain**
- Produces the **majority of ATP** (about 34-36 molecules total)
...
### What Are Traits?
Traits are characteristics that an organism inherits from its parents. Examples in humans: eye color, hair color, height, blood type, whether you can roll your tongue, attached or free earlobes.

### Inherited vs. Acquired Traits

**Inherited (hereditary) traits:** Passed from parent to offspring through DNA. You are born with these.
- Eye color, natural hair color, skin color
- Blood type, dimples, freckles
- Height potential, bone structure
- Genetic conditions (e.g., color blindness, sickle cell anemia)

**Acquired traits:** Developed during a person's lifetime, NOT passed through DNA.
- Scars, tattoos, piercings
- Muscle strength from exercise
- Learned skills (riding a bike, speaking a language)
- Knowledge, memories, habits
...
**Example: Eye color** where B = brown (dominant) and b = blue (recessive).

Cross: Bb (brown-eyed parent) × Bb (brown-eyed parent)
...
**Results:**
- BB = brown eyes (homozygous dominant) → 25%
- Bb = brown eyes (heterozygous) → 50%
- bb = blue eyes (homozygous recessive) → 25%
...
| Type | Living/Non-living | Examples | Description |
|---|---|---|---|
| **Bacteria** | Living | *E. coli*, *Streptococcus* | Single-celled prokaryotes; found everywhere |
| **Viruses** | Non-living (debated) | Flu virus, COVID-19, HIV | Require a host cell to reproduce |
| **Fungi** | Living | Yeast, mold, mushrooms | Decomposers; some are microscopic |
| **Protozoa** | Living | Amoeba, paramecium | Single-celled eukaryotes; many live in water |
| **Algae** | Living | Diatoms, green algae | Plant-like; make food through photosynthesis |

### Helpful Microorganisms
- **Bacteria in digestion:** Trillions of bacteria live in your intestines and help break down food, make vitamins (like vitamin K), and fight harmful bacteria.
- **Decomposers:** Bacteria and fungi break down dead organisms and recycle nutrients back into soil (composting).
- **Food production:** Bacteria make yogurt, cheese, sauerkraut, and pickles. Yeast (a fungus) makes bread rise and ferments drinks.
- **Medicine:** Bacteria produce antibiotics (like penicillin from the fungus *Penicillium*). Scientists genetically modify bacteria to produce insulin for diabetics.
- **Nitrogen fixation:** Certain bacteria convert nitrogen in the air into a form plants can use to grow.
- **Bioremediation:** Microbes are used to clean up oil spills and pollution.

### Harmful Microorganisms
- **Pathogens** are microorganisms that cause disease.
- **Bacterial diseases:** Strep throat (Streptococcus), tuberculosis, tetanus, food poisoning (Salmonella, E. coli).
- **Viral diseases:** Common cold, influenza (flu), measles, chickenpox, COVID-19.
- **Fungal infections:** Athlete's foot, ringworm.
- **Protozoan diseases:** Malaria (Plasmodium), dysentery.
...
|---|---|---|
| **Carbohydrates** | Main energy source | Bread, rice, pasta, potatoes, fruits |
| **Proteins** | Build and repair muscles, skin, organs | Meat, fish, eggs, beans, nuts, dairy |
| **Fats** | Long-term energy storage, insulation, brain health | Oils, butter, avocados, nuts, cheese |
| **Vitamins** | Various functions (vision, immunity, healing) | Fruits, vegetables, dairy |
...
- Supports brain function and concentration in school
- Keeps bones, muscles, and organs healthy
...
### What Is Matter?
Matter is anything that has **mass** and takes up **space (volume)**. Solids, liquids, and gases are all matter.
...
- **Archimedes' Principle:** The buoyant force on an object equals the weight of the fluid displaced by that object.
- An object floats when its weight is less than the buoyant force pushing up.
- Ships made of steel float because their shape displaces enough water to create a buoyant force greater than the ship's weight.

### Solubility
- Solubility is the ability of a substance (solute) to **dissolve** in another substance (solvent).
- A **solution** is a mixture where one substance dissolves evenly in another (e.g., salt in water).
- **Saturated solution:** No more solute can dissolve at that temperature.
- **Factors that affect solubility:**
  - **Temperature:** Most solids dissolve better in hot water; gases dissolve better in cold water.
  - **Stirring:** Speeds up dissolving but does not change how much can dissolve.
...
A chemical reaction occurs when **substances are changed into new substances** with different chemical properties. Bonds between atoms break and new bonds form.

### Key Terms
- **Reactants:** The starting substances (written on the left side of the equation).
- **Products:** The new substances formed (written on the right side of the equation).
...
- **Nucleus** (center): Contains **protons** (positive charge, +) and **neutrons** (no charge, neutral).
- **Electron cloud** (outer region): Contains **electrons** (negative charge, −) that orbit the nucleus.
- In a neutral atom: number of protons = number of electrons.

| Particle | Charge | Location | Mass |
|---|---|---|---|
| Proton | Positive (+) | Nucleus | 1 atomic mass unit |
| Neutron | Neutral (0) | Nucleus | 1 atomic mass unit |
| Electron | Negative (−) | Electron cloud | ~0 (very small) |
...
- Examples: Oxygen (O, 8 protons), Carbon (C, 6 protons), Gold (Au, 79 protons).
...
- **Rows** are called **periods** (7 periods).
- **Columns** are called **groups** or **families** (18 groups); elements in the same group have similar properties.
- Elements are classified as:
  - **Metals** (left/center): Shiny, conduct electricity, malleable, ductile (e.g., iron, gold, copper)
  - **Nonmetals** (right side): Dull, poor conductors, brittle (e.g., oxygen, carbon, nitrogen)
  - **Metalloids** (staircase line): Have properties of both metals and nonmetals (e.g., silicon)
- Each element square shows: symbol, atomic number, name, and atomic mass.
...
- Objects with **more mass** have **more inertia** (harder to start moving, harder to stop).
- **Examples:**
  - A ball on the ground stays still until you kick it.
  - A book on a table stays still because the table's upward force balances gravity.
...
- **Examples:**
  ...
  - A rocket propels upward because exhaust gases push downward.
  - When swimming, you push water backward, and the water pushes you forward.
...
|---|---|---|
| **Kinetic Energy** | Energy of motion | A moving car, a rolling ball |
| **Potential Energy** | Stored energy | A book on a high shelf, a stretched rubber band |
| **Thermal Energy** | Heat energy | Boiling water, the Sun |
| **Chemical Energy** | Stored in chemical bonds | Food, batteries, wood |
| **Electrical Energy** | Energy from moving electric charges | Lightning, power outlets |
| **Light (Radiant) Energy** | Energy from electromagnetic waves | Sunlight, a lightbulb |
| **Sound Energy** | Energy from vibrating objects | Music, clapping hands |
...
- A lightbulb: **electrical energy → light energy + thermal (heat) energy**
- Eating food: **chemical energy → kinetic energy** (movement) + **thermal energy** (body heat)
- A roller coaster: **potential energy → kinetic energy → potential energy** as it goes up and down
...
- **Alfred Wegener** (1912) proposed that all continents were once joined together as a single supercontinent called **Pangaea** ("all lands").
- Over millions of years, Pangaea broke apart and the continents slowly **drifted** to their current positions (continental drift).
- Evidence: matching coastlines (South America and Africa fit together), identical fossils on separated continents, matching rock formations, glacial evidence in now-tropical regions.

### Plate Tectonics Theory
Earth's **lithosphere** (crust + uppermost mantle) is broken into large pieces called **tectonic plates** that float on the semi-fluid **asthenosphere** and slowly move (a few centimeters per year), driven by **convection currents** in the mantle.

### Types of Plate Boundaries

| Boundary Type | Movement | Features Created |
|---|---|---|
| **Divergent** (constructive) | Plates move **apart** | Mid-ocean ridges, rift valleys, new crust |
| **Convergent** (destructive) | Plates move **together** | Mountains, ocean trenches, volcanoes, subduction zones |
| **Transform** (conservative) | Plates slide **past each other** | Earthquakes, faults (e.g., San Andreas Fault) |
...
### Volcanoes
- Occur mostly at **plate boundaries** (especially convergent boundaries where one plate subducts beneath another).
- **Magma** (molten rock underground) rises through cracks; when it reaches the surface it is called **lava**.
- **Shield volcanoes:** Broad, gentle slopes; formed by runny lava (e.g., Hawaiian Islands).
- **Composite volcanoes (stratovolcanoes):** Tall, steep, explosive; formed by thick lava and ash (e.g., Mount St. Helens, Mount Fuji).
- **Ring of Fire:** A horseshoe-shaped zone around the Pacific Ocean with many volcanoes and earthquakes.

---

## 13. Climate vs. Weather

### Weather
- Weather is the **short-term condition** of the atmosphere at a specific time and place.
- Changes from day to day and hour to hour.
- Measured by: temperature, humidity, air pressure, wind speed and direction, precipitation, cloud cover.
- A weather forecast tells you what to expect in the next few days.

### Climate
- Climate is the **long-term average** of weather patterns over 30 or more years in a region.
- Relatively stable and predictable.
- Examples: Tropical (hot and wet all year), Desert (hot and dry), Polar (cold year-round), Temperate (moderate with four seasons).

### Key Difference
| Weather | Climate |
|---|---|
| Short-term (day to day) | Long-term (years/decades) |
...
## 14. The Greenhouse Effect and Human Impact
...
- **Water pollution:** Chemicals, oil spills, plastic waste, fertilizers runoff into rivers and oceans; harms aquatic life.
...
- **Dwarf planet:** Pluto (reclassified in 2006).
...
### Eclipses
- **Solar eclipse:** The Moon passes between the Sun and Earth, blocking the Sun's light. Can be total (Sun completely covered) or partial.
- **Lunar eclipse:** Earth passes between the Sun and Moon, casting a shadow on the Moon. The Moon often appears reddish (called a "blood moon").
- Eclipses do NOT happen every month because the Moon's orbit is tilted relative to Earth's orbit.
...
- **Dependent variable (responding variable):** The factor you **measure** or observe; it changes in response to the independent variable.
- **Controlled variables (constants):** All the factors you keep the **same** so they don't affect the results.
...
- *Controlled variables:* Same type of plant, same soil, same water, same pot size.
...
- Scientists always consider whether there might be **errors** or **bias** in their experiments.

---

*This curriculum covers the major science topics for Grade 5 aligned with NGSS (Next Generation Science Standards) and state standards. Content can be adapted based on your state or district requirements.*
