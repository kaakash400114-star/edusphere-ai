...
### Key Concept
A **cell** is the basic unit of all living things. All living organisms are made of one or more cells. Inside cells are smaller structures called **organelles** ("little organs"), each with a specific job.

### Plant Cells vs Animal Cells

All cells share some features, but plant and animal cells have important differences:
...
| 🏭 **Ribosomes** | Tiny structures that make proteins | Tiny factories |
...
### Key Concept
**Photosynthesis** is the process by which plants convert light energy into chemical energy (food). It happens in the **chloroplasts** of plant cells, mostly in the leaves.

### The Word Equation

$$\text{Carbon Dioxide} + \text{Water} + \text{Sunlight} \rightarrow \text{Glucose (Sugar)} + \text{Oxygen}$$
...
|---|---|---|
| 🌱 **Biotic factors** | All the LIVING (or once-living) parts of an ecosystem | Trees, grass, insects, birds, bacteria, fungi, dead leaves, fish, worms |
| 🪨 **Abiotic factors** | All the NON-LIVING parts of an ecosystem | Sunlight, temperature, water, soil, rocks, air, wind, humidity, pH |

### How They Interact
Biotic and abiotic factors constantly affect each other:

| Interaction | Example |
|---|---|
| Abiotic → Biotic | Temperature determines which plants can survive; sunlight affects plant growth; rainfall determines animal populations |
| Biotic → Abiotic | Tree roots break apart rocks (biotic affecting abiotic); plants release oxygen into the air; beaver dams change water flow |
| Biotic → Biotic | Predator-prey relationships; competition for food; pollination; parasitism |

### Ecosystem Examples

| Ecosystem | Key Biotic Factors | Key Abiotic Factors |
|---|---|---|
| 🌳 **Forest** | Deer, oak trees, mushrooms, beetles, birds | Rainfall, sunlight through canopy, soil type, temperature |
| 🌊 **Coral Reef** | Coral, fish, sea turtles, algae, sharks | Warm water temperature, saltwater, clear sunlight, shallow depth |
| 🏜️ **Desert** | Cactus, scorpions, lizards, hawks, snakes | Hot temperatures, very little rain, sandy soil, intense sunlight |
| 🧊 **Tundra** | Mosses, caribou, arctic foxes, polar bears, lichens | Permafrost, cold temperatures, strong winds, long periods of darkness |
...
### Key Concept
A **food chain** shows how energy passes from one organism to another in a line. A **food web** shows many interconnected food chains in an ecosystem.

### Food Chain Levels

| Level | Name | Role | Example (Forest) | Example (Ocean) |
|---|---|---|---|---|
| 1 | 🌿 **Producer** | Makes food from sunlight | Oak tree | Phytoplankton |
...
**Why food webs are more realistic:** Most animals eat more than one type of food. If one food source disappears, the animal may have other options.
...
### Key Concept
Animal behavior is anything an animal does in response to its environment. Behaviors are either **instinctive** (born knowing how to do it) or **learned** (taught or figured out over time).

### Instinct vs Learned Behavior

| Feature | Instinct (Innate) Behavior | Learned Behavior |
|---|---|---|
...
### Key Concept
Plants reproduce in different ways to create new plants. The two main methods are **sexual reproduction** (using seeds) and **asexual reproduction** (using spores or plant parts).

### Pollination and Seed Formation

**Pollination** is the process of transferring pollen (male reproductive cells) from the stamen (male part) to the pistil (female part) of a flower.

| Pollination Type | How It Works | Examples |
|---|---|---|
| 🐝 **Animal pollination** | Animals carry pollen on their bodies as they move from flower to flower | Bees, butterflies, hummingbirds, bats pollinating flowers |
| 💨 **Wind pollination** | Wind carries pollen from one flower to another | Grasses, corn, wheat, oak trees (these flowers are usually small and don't have bright petals) |
| 💧 **Water pollination** | Water carries pollen (rare, but happens in some aquatic plants) | Some seaweeds and water plants |

### Parts of a Flower (Reproductive)
...
1. Pollen lands on the **stigma** of a flower
2. A pollen tube grows down the **style** to the **ovary**
3. Male cells from the pollen join with female cells in the **ovule** (fertilization)
4. The fertilized ovule becomes a **seed**
5. The ovary swells and becomes a **fruit** (which protects and helps disperse the seeds)

### Seed Dispersal Methods

| Method | How It Works | Examples |
|---|---|---|
| 🌬️ **Wind** | Seeds are light with wings or fluff | Dandelion, maple "helicopter" seeds, milkweed |
| 🐦 **Animals** | Animals eat fruit and drop seeds, or seeds stick to fur | Berries, burrs, acorns buried by squirrels |
| 💧 **Water** | Seeds float to new locations | Coconut, water lily |
| 💥 **Explosion** | Pods burst open and fling seeds | Peas, beans, touch-me-not |
...
| Feature | Details |
|---|---|
| What they are | Microscopic reproductive cells |
| Which plants use them | Ferns, mosses, mushrooms (fungi) |
| How they work | Spores are released into the air, land in a suitable spot, and grow into a new organism |
| Difference from seeds | Spores do NOT contain a stored food supply like seeds do, and they do NOT come from flowers |
...
|---|---|---|
| 🫁 **Respiratory** | Lungs, trachea, bronchi | Takes in oxygen, removes carbon dioxide |
| ❤️ **Circulatory** | Heart, blood vessels, blood | Transports oxygen, nutrients, and waste throughout the body |
| 🧠 **Nervous** | Brain, spinal cord, nerves | Controls and coordinates all body activities |
| 🍽️ **Digestive** | Mouth, esophagus, stomach, intestines | Breaks down food into nutrients the body can absorb |
| 🫘 **Excretory** | Kidneys, bladder, skin, lungs | Removes waste products from the body |
| 💪 **Muscular** | Muscles (skeletal, smooth, cardiac) | Enables movement, supports the body, pumps blood |
| 🦴 **Skeletal** | Bones, joints | Provides structure, protects organs, enables movement |

### Digestive System (Detailed)

**Job:** Break down food into nutrients and absorb them into the bloodstream.

| Part | Function | What Happens There |
|---|---|---|
| 👄 **Mouth** | Chewing (mechanical digestion); saliva starts chemical digestion of starches | Teeth grind food; saliva enzyme (amylase) begins breaking down carbohydrates |
| 🔽 **Esophagus** | Food tube connecting mouth to stomach | Muscles push food down by **peristalsis** (wave-like muscle contractions) |
| 🫙 **Stomach** | Churns food and uses acid and enzymes to break it down further | Food becomes a soupy liquid called **chyme**; stomach acid kills most harmful bacteria |
| 🧱 **Small Intestine** | Most digestion and nutrient absorption happens HERE | Nutrients are absorbed through tiny finger-like projections called **villi** into the blood |
| 🌊 **Large Intestine** | Absorbs water from remaining waste | Waste becomes solid (feces); bacteria here help break down remaining material |
| 🚪 **Rectum/Anus** | Stores and eliminates solid waste | Feces leave the body |

```
  Food's journey:
  Mouth → Esophagus → Stomach → Small Intestine → Large Intestine → Rectum
         (peristalsis)   (acid)   (nutrients absorbed)  (water absorbed)
```

> **Villi** are tiny, finger-like projections in the small intestine that increase the surface area for absorption. If you flattened all the villi in your small intestine, they would cover the area of a tennis court!

### Excretory System (Detailed)

**Job:** Remove waste products that could harm the body.
...
**Job:** Move the body, pump blood, and help organs function.
...
### Key Concept
**Electricity** is the flow of tiny particles called **electrons** through a conductor. A complete path for electricity to flow is called a **circuit**.

### Basic Circuit Components

| Component | What It Does | Symbol |
|---|---|---|
...
```
  SERIES:                    PARALLEL:
  ┌──Battery──Bulb──Bulb──┐   ┌──Battery──┬──Bulb──┐
  └───────────────────────┘   │          │         │
                               │          ├──Bulb──┤
                               │          │         │
                               └──────────┴─────────┘
...
| Type | Definition | Examples |
|---|---|---|
| ⚡ **Conductor** | Material that allows electricity to flow easily | Copper, aluminum, gold, silver, iron, steel, water with dissolved minerals |
| 🛡️ **Insulator** | Material that does NOT allow electricity to flow easily | Rubber, plastic, glass, wood, air, paper, cloth, pure water |

> **Why wires are coated:** Electric wires are made of copper (conductor) coated with plastic or rubber (insulator) so electricity stays IN the wire and doesn't escape to shock you!

### Static Electricity
**Static electricity** is a buildup of electric charge on the surface of an object, caused by friction between two materials.

| Key Term | Definition | Example |
|---|---|---|
| ⚡ **Static charge** | Electrical charge that stays in one place (doesn't flow) | Rubbing a balloon on your hair; clothes sticking together in the dryer |
| ➕ **Positive charge** | Object has LOST electrons | A balloon rubbed on hair becomes positively charged (electrons transferred to hair) |
| ➖ **Negative charge** | Object has GAINED electrons | The hair becomes negatively charged (gained electrons) |
| 🧲 **Like charges repel** | Two positive or two negative charges push away | Two balloons rubbed on hair repel each other |
| ❤️ **Unlike charges attract** | A positive and negative charge pull toward each other | A rubbed balloon sticks to a wall |

> **Lightning** is a massive discharge of static electricity built up in clouds. The charge difference between the ground and clouds becomes so large that electricity jumps across the gap!
...
### Key Concept
A **magnet** is an object that produces a magnetic field and attracts certain materials. Magnetism is a force that acts at a distance.

### Magnetic Poles

| Feature | Description |
|---|---|
| 🧲 **North pole** | One end of the magnet (points toward Earth's geographic north) |
...
|---|---|---|
| 🧲 **Magnetic materials** | Attracted to magnets | Iron, steel, nickel, cobalt |
| 🚫 **Non-magnetic materials** | NOT attracted to magnets | Wood, plastic, glass, paper, aluminum, copper, brass |

> **Important:** Not all metals are magnetic! Aluminum and copper are metals but are NOT magnetic. Only iron, nickel, and cobalt (and materials containing them, like steel) are strongly magnetic.

### Magnetic Field
A **magnetic field** is the invisible area around a magnet where its force can be felt.

```
  Magnetic field lines (invisible):
...
| Feature | Details |
|---|---|
| **How it works** | Electric current flowing through a wire creates a magnetic field around the wire. Coiling the wire makes the field stronger |
| **How to make it stronger** | More coils of wire, stronger current (more batteries), or an iron core inside the coil |
| **Advantage over regular magnets** | Can be turned ON and OFF, and the strength can be adjusted |
| **Real-world uses** | Doorbells, electric motors, cranes at junkyards (pick up cars!), MRI machines, speakers, hard drives |

### Earth as a Magnet

- Earth has a magnetic field because of the liquid iron in its **outer core** (moving charges create a magnetic field)
- A compass needle points north because it aligns with Earth's magnetic field
- Earth's magnetic field protects us from harmful solar radiation (acts like a shield)
- The magnetic North Pole is NOT exactly at the geographic North Pole (it moves slowly!)

### Common Misconceptions

| Misconception | Reality |
|---|---|
| "Magnets only attract metal" | Magnets only attract CERTAIN metals (iron, nickel, cobalt). They do NOT attract aluminum, copper, gold, or other metals |
| "Bigger magnets are always stronger" | Strength depends on the material and structure, not just size. A small neodymium magnet can be much stronger than a large ceramic one |
| "If you break a magnet, you get a north-only piece and a south-only piece" | Every magnet ALWAYS has both poles. Breaking it creates two complete magnets |

### Teaching Tip
Have students build an electromagnet by wrapping wire around an iron nail and connecting it to a battery. Test how many paper clips it can pick up, then experiment with more coils or stronger batteries.
...
1. Something **vibrates** (e.g., a guitar string, vocal cords, a drum head)
2. The vibration pushes and pulls on nearby air molecules
3. The molecules bump into each other, passing the disturbance along
4. This chain of pushes and pulls is a **sound wave**
5. The wave reaches your ear → your eardrum vibrates → your brain interprets it as sound
...
```
  ...
  ∿∿∿∿∿∿∿∿∿∿∿∿∿∿               ∿         ∿
                                  ∿         ∿
  LOUD (high amplitude):          SOFT (low amplitude):
  ∿∿∿∿∿∿∿∿∿∿∿∿∿∿               ∿  ∿  ∿  ∿
  (tall waves)                    (short waves)
```
...
|---|---|
| 🪨 **Solids** (fastest) | ~5,000 m/s (in steel) |
| 💧 **Liquids** | ~1,500 m/s (in water) |
| 💨 **Gases** (slowest) | ~343 m/s (in air, at 20°C) |

> **Why solids are fastest:** In solids, molecules are packed tightly together, so vibrations pass from one molecule to the next very quickly. In gases, molecules are spread far apart, so it takes longer.

### Human Hearing Range
Humans can hear sounds from about **20 Hz to 20,000 Hz**. Below 20 Hz = **infrasound** (elephants can hear it). Above 20,000 Hz = **ultrasound** (bats and dolphins use it for echolocation).
...
### Teaching Tip
Use a tuning fork or a ruler hanging off the edge of a desk (pluck it) to show vibrations. Have students compare the sound of short ruler segments (high frequency) vs long ones (low frequency). Stretch a rubber band between fingers and pluck it tight vs loose.
...
| Type of Surface | What Happens | Example |
|---|---|---|
| 🪞 **Smooth, shiny surface** | Light bounces off in a predictable, regular pattern (**specular reflection**) | Mirror, calm water surface, polished metal |
| 🧱 **Rough, uneven surface** | Light bounces off in many directions (**diffuse reflection**) | Wall, paper, clothing, rough wood |
...
> **Law of Reflection:** The angle of incidence (incoming ray) equals the angle of reflection (outgoing ray). Both angles are measured from the normal (a line perpendicular to the surface).

### Refraction

**Refraction** is when light **bends** as it passes from one medium to another with a different density (e.g., from air into water).

| Direction | What Happens |
|---|---|
| Air → Glass/Water (less dense → more dense) | Light bends **TOWARD** the normal line |
| Glass/Water → Air (more dense → less dense) | Light bends **AWAY** from the normal line |
...
**Real-life examples:**
- A straw in a glass of water looks **bent** at the water surface
- A swimming pool looks **shallower** than it really is
- A magnifying glass bends light to make things look bigger
- Mirages on hot roads (light bending through heated air)

### Prisms and White Light

**White light** from the Sun or a light bulb is actually a mixture of **all the colors of the visible spectrum**.

When white light passes through a **prism** (a triangular piece of glass), it refracts (bends) at different angles for each color because different colors travel at slightly different speeds in glass. This separates white light into its component colors.

```
  White light →  🔴 Orange  🟡 Yellow  🟢 Green  🔵 Blue  🟣 Indigo  💜 Violet
                  (dispersed by prism)
```

### Rainbow Formation

Rainbows form when sunlight shines through **water droplets** in the air:
...
### Key Concept
**Thermal energy** is the total energy of all the moving particles in an object. The faster the particles move, the more thermal energy the object has, and the **hotter** it feels.

### Temperature vs Thermal Energy

| Feature | Temperature | Thermal Energy |
|---|---|---|
| **What it measures** | The AVERAGE kinetic energy of particles | The TOTAL energy of all particles |
| **Depends on** | How fast particles are moving | How fast particles are moving AND how many particles there are |
| **Example** | A cup of boiling water and a pot of boiling water have the SAME temperature, but the pot has MORE thermal energy (more water = more particles) | |
| **Unit** | °C, °F, or K | Joules (J) |
...
### Methods of Heat Transfer (Review from Grade 3)

| Method | Description | Example |
|---|---|---|
| 🔥 **Conduction** | Transfer through direct contact between particles | Ironing clothes; touching a hot mug |
| 💨 **Convection** | Transfer through the movement of heated fluids (liquids/gases) | Hot air balloon rising; boiling water circulating |
| ☀️ **Radiation** | Transfer through electromagnetic waves (no contact needed) | Feeling warmth from a fire; microwave heating food |

### Thermal Energy and States of Matter

| State | Particle Motion | Thermal Energy |
|---|---|---|
| 🧊 Solid | Particles vibrate in fixed positions | Lowest thermal energy |
| 💧 Liquid | Particles slide past each other | Medium thermal energy |
| 💨 Gas | Particles move freely at high speed | Highest thermal energy |
...
- Gas → **deposition** → Solid (like frost forming)
...
### Teaching Tip
Place ice cubes in three bowls: one with nothing (air), one with cold water, and one with aluminum foil. Students predict which melts fastest and why, connecting to conduction and the properties of different materials.
...
Rocks change continuously through three types:

| Type | Formation | Key Characteristics | Examples |
|---|---|---|---|
| 🔥 **Igneous** | Cools and hardens from magma or lava | Can have visible crystals (if slow cooling) or be glassy (if fast cooling) | Granite, basalt, obsidian, pumice, scoria |
| 🏔️ **Sedimentary** | Layers of sediment compressed and cemented together | Often has visible layers (strata); may contain fossils | Sandstone, limestone, shale, conglomerate |
| 🔄 **Metamorphic** | Existing rocks changed by extreme heat and pressure | Often has banded or foliated appearance; very hard | Marble (from limestone), slate (from shale), quartzite (from sandstone), gneiss |

### Fossils

A **fossil** is the preserved remains or evidence of a living thing from the distant past.

| Fossil Type | How It Forms | Examples |
|---|---|---|
| 🦴 **Body fossil** | The actual body (or parts of it) is preserved in rock | Bones, teeth, shells, amber with insects |
| 🐾 **Trace fossil** | Evidence of activity, not the body itself | Footprints, burrows, coprolites (fossil poop), bite marks |
| 🌿 **Mold fossil** | An organism leaves an impression in soft sediment that hardens | Leaf impressions, shell imprints |
| 💎 **Cast fossil** | Minerals fill a mold, creating a 3D copy of the organism | Cast of a shell, cast of a bone |
| 🪨 **Petrified fossil** | Minerals replace the organism's tissues over time, turning them to stone | Petrified wood, petrified bone |

> **Fossils are mostly found in sedimentary rock** because the process of sediment layering and compression is ideal for preservation. Igneous and metamorphic rocks form under conditions (extreme heat/pressure) that usually destroy fossils.

### Renewable vs Non-Renewable Resources

| Type | Definition | Examples | Pros | Cons |
|---|---|---|---|---|
| 🌱 **Renewable** | Resources that can be replaced naturally in a short time | Solar energy, wind energy, hydroelectric power, geothermal energy, biomass, wood | Never runs out; cleaner; sustainable | Can be expensive to set up; weather-dependent (solar, wind) |
| 🛢️ **Non-Renewable** | Resources that exist in limited amounts and take millions of years to form | Coal, oil, natural gas (fossil fuels); nuclear energy (uranium) | Currently cheap and efficient; widely available | Will run out; causes pollution; greenhouse gases; mining damages environment |

> **Important:** Fossil fuels (coal, oil, natural gas) come from the remains of ancient plants and animals that were buried and compressed over millions of years. Burning them releases carbon dioxide, which contributes to climate change.
...
### Key Concept
The **atmosphere** is the layer of gases that surrounds Earth. It protects us from the Sun's harmful radiation, traps heat to keep us warm, and provides the air we breathe.
...
```
  ...
  ─────────────────────────────────────────────────
  🌌 Thermosphere (ISS, auroras)
  ─────────────────────────────────────────────────
  🌡️ Mesosphere (meteors burn up)
  ─────────────────────────────────────────────────
  🌀 Stratosphere (ozone layer, jets)
  ─────────────────────────────────────────────────
  ☁️ Troposphere (weather, us)
  ══════════════════════════════════════════════════
  🌍 Earth
```
...
| Planet | Distance from Sun | Size | Composition | Known For |
|---|---|---|---|---|
| 🟤 **Jupiter** | 5.2 AU (778M km) | LARGEST (11× Earth's diameter) | Hydrogen and helium gas | Great Red Spot (storm larger than Earth); 95+ moons; strongest magnetic field; has faint rings |
| 🟡 **Saturn** | 9.5 AU (1.4B km) | Second largest | Hydrogen and helium | Spectacular rings of ice and rock; 146+ moons; least dense planet (would float in water!) |
| 💚 **Uranus** | 19.2 AU (2.9B km) | About 4× Earth's diameter | Water, methane, ammonia (ice giants) | Rotates on its SIDE (98° tilt); appears blue-green due to methane; 27 moons; faint rings |
| 🔵 **Neptune** | 30.1 AU (4.5B km) | Slightly smaller than Uranus | Water, methane, ammonia | Strongest winds in the solar system (2,100 km/h); appears deep blue; 16 moons |

> **AU (Astronomical Unit):** The distance from Earth to the Sun, about 150 million km. It's a convenient unit for measuring distances in the solar system.

### Dwarf Planets
After Pluto was reclassified in 2006, the IAU created the "dwarf planet" category:

| Dwarf Planet | Location | Key Feature |
|---|---|---|
| 🪐 **Pluto** | Kuiper Belt (beyond Neptune) | Has a heart-shaped nitrogen ice plain; 5 moons |
| ⭕ **Ceres** | Asteroid Belt (between Mars and Jupiter) | Largest object in the asteroid belt |
| 🔵 **Eris** | Beyond Neptune | Slightly smaller than Pluto but more massive |
| 💜 **Haumea** | Kuiper Belt | Shaped like an egg (elongated); has rings |
...
### Teaching Tip
Create a scaled model of the solar system. On a long hallway or field, place planets at proportional distances. Students are always amazed at how much EMPTY SPACE exists between the planets!

---

## 16. Space Exploration, Comets, and Asteroids

### Key Concept
Space exploration has taught us about our solar system and beyond. Space contains not just planets and stars, but also smaller objects like **comets**, **asteroids**, and **meteoroids**.
...
| 1971 | Mars 3 (USSR) | First spacecraft to land on Mars |
| 1977 | Voyager 1 & 2 (USA) | Launched to explore outer planets; Voyager 1 is now in interstellar space |
| 1990 | Hubble Space Telescope (USA/Europe) | Revolutionized astronomy with deep space images |
| 1998 | International Space Station (ISS) | Continuous human presence in space since 2000 |
| 2012 | Curiosity Rover (USA) | Explored Mars surface for signs of past habitability |
| 2021 | James Webb Space Telescope (USA/Europe/Canada) | Most powerful space telescope; sees infrared light from the early universe |
| 2025 | Artemis Program (USA) | Ongoing effort to return humans to the Moon (and eventually Mars) |

### Tools of Space Exploration

| Tool | What It Does | Example |
|---|---|---|
| 🔭 **Telescopes** | Collect and magnify light from distant objects | Hubble, James Webb, ground-based observatories |
| 🛰️ **Satellites** | Orbit Earth for communication, weather, navigation, research | GPS satellites, weather satellites |
| 🚀 **Space Probes** | Unmanned spacecraft sent to explore other planets, moons, or deep space | Voyager, New Horizons (Pluto), Cassini (Saturn) |
| 🤖 **Rovers** | Robotic vehicles that explore planet surfaces | Spirit, Opportunity, Curiosity, Perseverance (Mars) |
| 🧪 **Space Stations** | Habitats in orbit where astronauts live and conduct research | ISS (International Space Station), Tiangong (China) |
...
### Key Concept
**Engineering** is the process of designing, building, testing, and improving solutions to real-world problems. The **Engineering Design Process (EDP)** is a step-by-step method engineers use.

### The Engineering Design Process

| Step | What You Do | Key Questions |
|---|---|---|
| 1️⃣ **Ask (Define the Problem)** | Identify the problem you want to solve and any constraints (limits) | What is the problem? Who is it for? What are the rules or limits? |
| 2️⃣ **Imagine (Brainstorm Solutions)** | Think of as many possible solutions as you can | What are different ways to solve this? What has been tried before? |
| 3️⃣ **Plan (Select a Design)** | Choose the best idea and plan how to build it | Which idea is best and why? What materials do I need? What steps will I follow? |
...
**Constraints** are the limits or rules an engineer must work within:

| Type of Constraint | Example |
|---|---|
| 💰 **Budget (cost)** | The bridge must cost less than $1,000 |
...
| EDP Step | Application |
|---|---|
| **Ask** | Build a bridge that can hold 50 pennies using only paper and tape |
| **Imagine** | Fold the paper? Roll it? Make triangles? Layer it? |
...
|---|---|---|
| **Goal** | Understand the natural world | Design solutions to problems |
| **Process** | Scientific Method (observe, hypothesize, experiment, conclude) | Engineering Design Process (ask, imagine, plan, create, test, improve) |
| **Outcome** | New knowledge, theories, laws | Products, systems, structures, processes |
| **Question** | "How does this work?" | "How can I make this work better?" |

> **They work together!** Engineers use scientific knowledge to design things, and scientists use engineered tools (microscopes, telescopes, spacecraft) to make discoveries.

### Common Misconceptions

| Misconception | Reality |
|---|---|
| "Engineering is the same as science" | Science is about DISCOVERING how the world works. Engineering is about DESIGNING solutions to problems. They are related but different |
| "There is one right answer" | There are often MANY valid solutions to a problem. The best solution depends on the constraints and requirements |
