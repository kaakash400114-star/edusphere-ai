...
3. **Adding manure and fertilisers**:
   ...
   - Crop rotation with legumes (rhizobium fixes nitrogen) restores fertility.
4. **Irrigation**: supplying water. Sources: wells, tubewells, lakes, rivers, canals. Traditional: moat, chain pump, dhekli, rahat. Modern: sprinkler (water-saving), drip (drop-by-drop at roots, best for saved water).
5. **Weeding**: **Weeds** (unwanted plants, e.g. wild oat, grass) removed by **weedicides** or uprooting; they steal water and nutrients.
6. **Harvesting**: cutting the mature crop (sickle or harvester). **Threshing** separates grain from stalk; **winnowing** separates grain from chaff.
7. **Storage**: grains dried in sun, stored in jute bags or metal bins; large stores = silos and granaries.
...
- **Making curd and cheese**: Lactobacillus bacteria turn milk into curd.
- **Bread, idli, dosa**: yeast produces CO2, making dough rise.
- **Fermentation**: conversion of sugar into alcohol by yeast.
- **Medicines**: antibiotics (penicillin from a fungus) kill bacteria; vaccines give immunity.
- **Cleaning**: bacteria decompose organic waste (sewage treatment).
- **Nitrogen fixation**: Rhizobium in legume root nodules; increases soil fertility.

### Harmful Microorganisms (Pathogens)
- **Diseases**: cholera, tuberculosis (bacteria); malaria, sleeping sickness (protozoa); ringworm (fungi); polio, measles, dengue (viruses).
- **Food poisoning**: eating food spoiled by microbes.
- **Plant diseases**: citrus canker (bacteria), rust of wheat (fungi), yellow vein mosaic of bhindi (virus).
...
### Nitrogen Cycle
- Nitrogen gas is 78% of air but plants cannot use it directly.
- Fixed by lightning, Rhizobium, blue-green algae → nitrates in soil → absorbed by plants → passed to animals → returned by decomposition and denitrifying bacteria.
- The cycle keeps nitrogen levels in the atmosphere and soil balanced.
...
### Natural Resources
- **Inexhaustible**: sunlight, air, water. **Exhaustible**: coal, petroleum, natural gas (fossil fuels, made over millions of years from dead organisms under heat and pressure).
...
- **Products**: petrol (vehicles), diesel (heavy vehicles, generators), kerosene (stove, jet fuel), LPG (cooking), paraffin wax (candles), lubricating oil, bitumen (roads), petrochemicals (plastics, detergents, synthetic fibres).

### Natural Gas
- Clean fuel; CNG (compressed natural gas) for vehicles; used for power generation and as industrial fuel.

### Conservation Tips
- Use CNG/clean fuels, switch off engines at red lights, use public transport, use solar cookers/pressure cookers, prefer LED bulbs, take stairs.
- Because fossil fuels are exhaustible, saving them is essential.
...
### Combustion
- A chemical process in which a substance reacts with oxygen to give heat (and usually light). The substance burned is the **fuel**.
- **Types**:
  - **Rapid combustion**: gas burns quickly producing heat and light (LPG stove).
  - **Spontaneous combustion**: burns by itself without apparent cause (phosphorus, forest fires in hot dry weather).
  - **Explosion**: burning with sudden release of heat, light and sound (firecrackers).
...
- **Dark inner zone**: unburnt wax vapour (least hot).
- **Luminous middle zone**: partial combustion; yellow, glowing (unburnt carbon particles make it luminous).
- **Non-luminous outer zone**: complete combustion; hottest part (blue).
- A candle burns with a yellow flame (incomplete combustion); LPG burns with a blue flame (complete combustion).
...
- Cutting trees on a large scale for agriculture, roads, housing, factories, timber, fuel.
...
- All living organisms are made of cells. Number of cells: unicellular (amoeba, chlamydomonas) vs multicellular (humans, plants).
- Shape varies with function (nerve cell long, muscle cell spindle); size varies (smallest bacteria to ostrich egg).
...
- **Vacuole**: storage sac. Large central vacuole in plant cells; small or absent in animal cells.

### Comparison: Plant vs Animal Cell
- Plant: cell wall present, plastids present, large vacuole.
- Animal: no cell wall, no plastids, small vacuoles.
...
- **Sexual reproduction**: male and female gametes fuse (zygote → new individual).
- **Asexual reproduction**: single parent (e.g., hydra buds off, amoeba divides binary fission).
...
- Examples: a rubber sucker sticks because removing air under it lets atmospheric pressure press it to the wall; a dropper works by air pressure.
...
### What Friction Is
- The force that opposes relative motion between two surfaces in contact. Acts along the surfaces, opposite to motion.
- Caused by interlocking of irregularities on the two surfaces.
...
- **Disadvantages**: wears out soles, machine parts, produces heat (machine heating), wastes energy.
...
- Bubbles of gas form on electrodes.
- Metal deposits on an electrode.
- Colour of solution may change.

### Electroplating
- Depositing a thin layer of a desired metal on another material by electric current.
- **Uses**: chromium plating on car parts/taps (shine + rust protection), tin plating on iron cans (food safety), silver/gold plating on jewellery (cheap base metal, precious coating).
- The object to be plated is the negative electrode; the plating metal is the positive electrode; the solution contains salts of the plating metal.
...
### Lightning
- A huge electric spark between clouds, or between clouds and the earth.
- Charging by rubbing: clouds get **electrically charged** by friction of water droplets and air currents; opposite charges attract and a giant spark equalises them.
- **Safety during lightning**: stay indoors, avoid open fields, tall trees, metal poles, umbrellas with metal rods, water bodies; if in a car, stay inside (the metal body conducts charge safely to the ground). Lightning conductors protect buildings (metal rod from top of building into the ground).

### Earthquakes
- Sudden shaking of the earth's crust, caused by disturbance deep inside (movement of tectonic plates).
- **Seismic waves** are recorded on a **seismograph**; power measured on the **Richter scale**.
- **Safety**: take shelter under a strong table; stay away from glass and heavy objects; if outdoors, move to open ground away from buildings, trees, power lines.
...
- Light travels in straight lines. We see objects when light from them enters our eyes (light reflected off objects).

### Reflection of Light
- Bouncing back of light from a surface. Laws of reflection:
...
- The point on the retina with no light-sensitive cells is the blind spot.
- Care: balanced diet (vitamin A), proper light while reading, don't rub eyes with dirty hands, regular eye check-ups, distance from screens.

### Angles and Mirrors at Work
- **Angle of incidence = angle of reflection** makes devices like periscopes (two mirrors at 45°), kaleidoscopes (coloured patterns from mirror reflections) possible.
